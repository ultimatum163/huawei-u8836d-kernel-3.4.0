...
bool Speaker_Init(void)
{
   PRINTK("+Speaker_Init Success");
	mt_set_gpio_mode(GPIO_APA_CTRL_1_PIN,GPIO_MODE_00);  // gpio mode
	mt_set_gpio_pull_enable(GPIO_APA_CTRL_1_PIN,GPIO_PULL_ENABLE);
	mt_set_gpio_dir(GPIO_APA_CTRL_1_PIN,GPIO_DIR_OUT);
	mt_set_gpio_out(GPIO_APA_CTRL_1_PIN,GPIO_OUT_ZERO);


	mt_set_gpio_mode(GPIO_APA_CTRL_2_PIN,GPIO_MODE_00);  // gpio mode
	mt_set_gpio_pull_enable(GPIO_APA_CTRL_2_PIN,GPIO_PULL_ENABLE);
	mt_set_gpio_dir(GPIO_APA_CTRL_2_PIN,GPIO_DIR_OUT);
	mt_set_gpio_out(GPIO_APA_CTRL_2_PIN,GPIO_OUT_ZERO);
...
void Sound_Speaker_Turnon(int channel)
{
    ...
    mt_set_gpio_dir(GPIO_APA_CTRL_1_PIN,GPIO_DIR_OUT);   
    mt_set_gpio_out(GPIO_APA_CTRL_1_PIN,GPIO_OUT_ONE); 
    mt_set_gpio_dir(GPIO_APA_CTRL_2_PIN,GPIO_DIR_OUT);   
    mt_set_gpio_out(GPIO_APA_CTRL_2_PIN,GPIO_OUT_ONE);
